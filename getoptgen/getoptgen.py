...
help_page += format_arg_option("s_cacert=filename", "Specifies the X.509 CA certificate that issues server certificates, in PEM format.")
help_page += format_arg_option("s_cakey=filename", "Specifies the X.509 CA certificate key that signs server certificates, in PEM format.")
help_page += format_arg_option("s_ciphers=ciphers", "Specifies the cipher suite string that the ratched TLS server uses.")
help_page += format_arg_option("s_groups=groups", "Specifies the key agreement 'supported groups' string (formerly known as 'elliptic curves') that the ratched TLS server uses.")
...
help_page += format_arg_option("c_keyfile=filename", "Specifies the private key for the given client certificate, in PEM format.")
help_page += format_arg_option("c_chainfile=filename", "Specifies the X.509 certificate chain that is to be sent to the server, in PEM format.")
help_page += format_arg_option("c_ciphers=ciphers", "Specifies the cipher suite string that the ratched TLS client uses.")
help_page += format_arg_option("c_groups=groups", "Specifies the key agreement 'supported groups' string (formerly known as 'elliptic curves') that the ratched TLS client uses.")
...
help_page += format_example("$ ratched --intercept www.johannes-bauer.com,c_cerfile=joe.crt,c_keyfile=joe.key -o output.pcapng", "Same as before, but for connections to johannes-bauer.com, do not forge client certificates, but always use the given client certificate and key (joe.crt / joe.key) for authentication against the server.")
